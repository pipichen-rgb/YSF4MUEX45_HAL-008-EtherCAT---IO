...
typedef struct OBJ_STRUCT_PACKED_START {
   ...
   BOOLEAN(bSwitch2); /**< \brief Switch 1*/
   BOOLEAN(bSwitch3); /**< \brief Switch 1*/
   ALIGN13(SubIndex009) /**< \brief 8Bit alignment*/
} OBJ_STRUCT_PACKED_END
TOBJ6000;
...
typedef struct OBJ_STRUCT_PACKED_START {
   ...
   BOOLEAN(bLED2); /**< \brief LED 1*/
   ALIGN14(SubIndex008) /**< \brief 8Bit alignment*/
} OBJ_STRUCT_PACKED_END
TOBJ7010;
/** @}*/
...
#ifdef _EVALBOARD_
 = {4, {0x60000101,0x60000201,0x60000301, 0x0C}}
#endif
;
...
OBJCONST TSDOINFOENTRYDESC    OBJMEM asEntryDesc0x6000[] = {
   ...
   {0x0000, 0x0C, 0}}; /* Subindex 009 for align */
...
OBJCONST TSDOINFOENTRYDESC    OBJMEM asEntryDesc0x7010[] = {
   ...
   {0x0000, 0x0E, 0}}; /* Subindex 008 for align */
...
//   {NULL,NULL,   0x1A02, {DEFTYPE_PDOMAPPING, 8 | (OBJCODE_REC << 8)}, asEntryDesc0x1A02, aName0x1A02, &sAITxPDOMap, NULL, NULL, 0x0000 },
   ...
   /* Object 0x6000 */
   {NULL,NULL,   0x6000, {DEFTYPE_RECORD, 4 | (OBJCODE_REC << 8)}, asEntryDesc0x6000, aName0x6000, &sDIInputs, NULL, NULL, 0x0000 },
   /* Object 0x6020 */
